...
export default function DetailedAnalysisPage() {
    ...
    return (
        <div className="bg-background flex min-h-screen flex-col font-sans selection:bg-[#0071e3]/20">
            ...
            <main className="relative z-10 container mx-auto flex w-full max-w-[1400px] flex-1 flex-col px-4 py-8 md:px-8 md:py-12">
                <div className="mb-6">
                    <Button
                        variant="ghost"
                        onClick={() => router.back()}
                        className="group -ml-4 flex items-center gap-2 text-muted-foreground hover:text-foreground"
                    >
                ...
                {loading ? (
                    ...
                    <div className="flex flex-1 flex-col items-center justify-center min-h-[50vh] text-center">
