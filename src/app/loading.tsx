    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-6">
        ...
        <div className="relative flex h-20 w-20 items-center justify-center">
          ...
          <div className="h-12 w-12 rounded-full border border-white/40 bg-white/50 shadow-sm backdrop-blur-md dark:border-white/10 dark:bg-white/10"></div>
        </div>

        <div className="space-y-2 text-center">
          <h3 className="text-[15px] font-medium tracking-wide text-gray-900 dark:text-white">
            加载中
          </h3>
